package com.mera.education.grpc.task.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Task> greetingConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Task> greetingKafkaListenerContainerFactory() {
